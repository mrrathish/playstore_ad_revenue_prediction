...
Xtrain_path = "hf://datasets/Retheesh/play-store-ad-revenue-prediction/Xtrain.csv"
Xtest_path = "hf://datasets/Retheesh/play-store-ad-revenue-prediction/Xtest.csv"
ytrain_path = "hf://datasets/Retheesh/play-store-ad-revenue-prediction/ytrain.csv"
ytest_path = "hf://datasets/Retheesh/play-store-ad-revenue-prediction/ytest.csv"
...
Xtest = pd.read_csv(Xtest_path, nrows=50)
ytrain = pd.read_csv(ytrain_path, nrows=500)
ytest = pd.read_csv(ytest_path, nrows=50)
...
with mlflow.start_run():
    ...
    repo_id = "Retheesh/playstore_revenue_model"
    repo_type = "model"
